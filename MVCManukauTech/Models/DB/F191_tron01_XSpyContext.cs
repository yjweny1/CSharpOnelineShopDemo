...
{
    public partial class F191_tron01_XSpyContext : DbContext
    {
        public F191_tron01_XSpyContext()
        {
        }

        public F191_tron01_XSpyContext(DbContextOptions<F191_tron01_XSpyContext> options)
            : base(options)
        {
        }
